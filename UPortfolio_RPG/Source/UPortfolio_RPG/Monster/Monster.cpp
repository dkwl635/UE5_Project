...
AMonster::AMonster()
{
	...
	// Initialize timeline
		if (ScreamCurve)
		{
			...
			//ScreamTimeline.SetTimelineLengthMode(ETimelineLengthMode::TL_LastKeyFrame); // Ÿ�Ӷ��� ���̸� ������ Ű�����ӱ����� �����մϴ�.
			//ScreamTimeline->OnTimelineFinished.AddDynamic(this, &AMonster::OnFinishFire); // Ÿ�Ӷ����� �Ϸ�� �� ȣ��� �Լ� ����
...
{
	GetWorldTimerManager().SetTimer(DelayTimerHandle, this, &AMonster::ScreamDelay, 1.0f, false); // 1�� ����
